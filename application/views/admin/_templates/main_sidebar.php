		...
		<ul class="sidebar-menu">
			<li>
				<a href="<?php echo site_url('/'); ?>">
					...
					<span>
						<?php echo lang('menu_access_website'); ?>
					</span>
				</a>
			</li>

			<li class="header text-uppercase">
				<?php echo lang('menu_main_navigation'); ?>
			</li>
			...
			<li class="<?=active_link_controller('database')?>">
				<a href="<?php echo site_url('admin/database'); ?>">
					...
					<span>
						<?php echo lang('menu_database_utility'); ?>
					</span>
				</a>
			</li>
